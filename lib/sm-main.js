...
module.exports = {
  ...
  activate: function (state) {
    ...
    subscriptions.add(
      ...
      atom.commands.add('atom-text-editor', { 'sm:createHeading1': (event) => BufferUtils.createHeading1() }),
      atom.commands.add('atom-text-editor', { 'sm:createHeading2': (event) => BufferUtils.createHeading2() }),
      atom.commands.add('atom-text-editor', { 'sm:createHeading3': (event) => BufferUtils.createHeading3() }),
      atom.commands.add('atom-text-editor', { 'sm:createQuote': (event) => BufferUtils.createQuote() }),
      atom.commands.add('atom-text-editor', { 'sm:deleteLine': (event) => BufferUtils.deleteLine() }),
