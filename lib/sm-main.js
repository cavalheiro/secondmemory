...
module.exports = {
  ...
  activate: function (state) {
    ...
    subscriptions.add(
      ...
      atom.commands.add('atom-text-editor', { 'sm:chat': (event) => BufferUtils.rotLabel(SymbolConf.chat) }),
      ...
      atom.commands.add('atom-text-editor', { 'sm:insertDateWorkday': (event) => BufferUtils.insertDateWorkday() }),
      atom.commands.add('atom-text-editor', { 'sm:insertDateWeekNumber': (event) => BufferUtils.insertDateWeekNumber() }),
      atom.commands.add('atom-text-editor', { 'sm:star': (event) => BufferUtils.rotLabel(SymbolConf.star) }),
      atom.commands.add('atom-text-editor', { 'sm:question': (event) => BufferUtils.rotLabel(SymbolConf.question) }),
      atom.commands.add('atom-text-editor', { 'sm:exclamation': (event) => BufferUtils.rotLabel(SymbolConf.exclamation) }),
