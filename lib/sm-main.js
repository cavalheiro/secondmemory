...
module.exports = {
  ...
  activate: function (state) {
    ...
    subscriptions.add(
      ...
      atom.commands.add('atom-text-editor', { 'sm:createHeading': (event) => BufferUtils.rotLabel(BulletConf.heading, 1) }),
      atom.commands.add('atom-text-editor', { 'sm:toggleStar': (event) => BufferUtils.star() }),
